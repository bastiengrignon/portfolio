...
const projects: ProjectsProps[] = [
    {
        ...
        tagList: ["React", "Typescript", "TailwindCSS", "Heroku"]
    },
    {
        name: "Aéroglisseur",
        description: (
    ...
    },
    {
        ...
        tagList: ["c/c++", "électronique", "Arduino"]
    },
    {
        ...
        description: (
            <div>
                ...
                <div className="mt-4">
                    ...
                    <img src={`${projectFolder}/ihm_pc.png`} alt={`${projectFolder}/ihm_pc.png`}/>
                </div>
            </div>
        ),
        img: `${projectFolder}/case_pcb.png`,
        tagList: ["c/c++", "Qt", "Électronique", "LoRa"]
    },
    {
        name: "Ce site web",
        description: (
        ...
        tagList: ["React", "Typescript", "TailwindCSS", "ESLint", "GitHub pages", "Heroku", "i18n"]
    }
]
